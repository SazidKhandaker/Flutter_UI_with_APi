...
class _MyHomePageState extends State<MyHomePage> {
  List<Music> playlist = [
    new Music('Dreams', 'Dreams Team', 'assets/img/un.jpg',
        'https://www.bensound.com/royalty-free-music?download=dreams'),
    new Music('Endless Motion', 'Ema area', 'assets/img/deux.jpg',
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    new Row(
                      ...
                      children: <Widget>[
                        buttonStyleWidget(
                            Icons.fast_rewind, 30.0, ActionMusic.rewind),
                        buttonStyleWidget(
                            ...
                            (statut == PlayerState.playing)
                                ...
                                : ActionMusic.play),
                        buttonStyleWidget(
                            Icons.fast_forward, 30.0, ActionMusic.forward),
                      ],
                    ),
                    new SizedBox(
                      height: 100.0,
  ...
  IconButton buttonStyleWidget(
      IconData icone, double size, ActionMusic action) {
